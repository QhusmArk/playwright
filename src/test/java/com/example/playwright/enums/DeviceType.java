...
public enum DeviceType {
    ...
    /**
     * @return C22 from '/company/devices/C22/101915/settings/monitoring'
    ...
    public static DeviceType getMonitoringDeviceFromCurrentUrl(String url) {
        try {
            ...
            return DeviceType.fromType(DeviceProperties.getKey(serial));
    ...
    public boolean isCommunicatingDevice() {
