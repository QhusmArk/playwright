...
//    *********************************************
    ...
    public Icon completeGetIcon(final String parentPath) {
        return iconPO.getIcon(parentPath);
    }

    public Icon getIcon(final String elementPath) {
        return iconPO.getIcon2(elementPath);
    }
...
//        IntStream.rangeClosed(1, menuOptionCount)
//                .mapToObj(o -> {
//                    String menuOptionPath = "//div[@role='listbox'] //div[@role='option'][" + o + "]";
//                    return getMenuOption(menuOptionPath);
//                })
//                .forEach(menuOptions::add);
